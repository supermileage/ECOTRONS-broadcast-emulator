...
const CanMessage BMS_RESPONSE[] =   {{BMS_RESPONSE_ID, 8, {0x01,0x11,0x24,0x01,0x00,0x00,0x00,0x00}},   // Latest Events Timestamp - 1
                                    {BMS_RESPONSE_ID, 8, {0x01,0x11,0x24,0x10,0x00,0x00,0x03,0x01}},    // Latest Events - Over-Voltage Cutoff
                                    {BMS_RESPONSE_ID, 8, {0x01,0x11,0x24,0x00,0x01,0x00,0x61,0x02}},    // Latest Events - System Started
                                    {BMS_RESPONSE_ID, 6, {0x01,0x14,0x00,0x00,0x40,0x42}},              // Pack Voltage         - 48.0
                                    ...
                                    {BMS_RESPONSE_ID, 4, {0x01,0x18,0x93,0x9B}},                        // Current Status       - FAULT
